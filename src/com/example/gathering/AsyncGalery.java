...
class AsyncGalery extends AsyncTask<String, Integer, Boolean>{
	Bitmap barray[];
	private ProgressDialog 	pd;
	String idn[];
	String ids[];
	public AsyncGalery(String ids[], String idn[] ){
		this.ids = ids;
		this.idn = idn;
	...
	protected void onPreExecute(){
		pd = ProgressDialog.show(Galery.gthis, "", "Download Picture");
